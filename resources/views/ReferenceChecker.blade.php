...
<body class="bg-gray-100 p-4">
    <div class="max-w-7xl mx-auto">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Cross-Education Schedule Checker</h1>
        <p class="text-gray-600 mb-6">Instructors teaching in both Basic Education and College</p>
        
        @if(count($crossEducationInstructors) > 0)
            <div class="space-y-6">
                @foreach($crossEducationInstructors as $instructorData)
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            ...
                            <div class="bg-blue-50 rounded-lg p-4">
                                ...
                                @if(count($instructorData['reference_schedules']) > 0)
                                    <div class="space-y-3">
                                        @foreach($instructorData['reference_schedules'] as $ref)
                            ...
                            <div class="bg-green-50 rounded-lg p-4">
                                ...
                                @if(count($instructorData['college_schedules']) > 0)
                                    <div class="space-y-3">
                                        @foreach($instructorData['college_schedules'] as $col)
        ...
        @else
            <div class="bg-white rounded-lg shadow-md p-6 text-center">
                ...
                <p class="text-lg text-gray-600 mb-2">No instructors found teaching in both Basic Education and College</p>
                <p class="text-sm text-gray-500">All instructors are uniquely assigned to either Basic Education or College schedules.</p>
            </div>
        @endif
    </div>
</body>
